...
def get_targetset(dataset_name, args, config):
    ...
    if dataset_name == "CIFAR10":
        ...
        # target class
        data_path = os.path.join(folder_path, 'MNIST_class', 'train', str(args.target_label))
        test_data_path = os.path.join(folder_path, 'MNIST_class', 'test', str(args.target_label))
