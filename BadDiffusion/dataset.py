...
class DatasetLoader(object):
    ...
    def __load_dataset(self, name: str):
        ...
        if name == DatasetLoader.MNIST:
            ...
            return load_dataset("./cifar10.py", split=split_method, cache_dir="./")
        elif name == DatasetLoader.CELEBA:
            return load_dataset("student/celebA", split='train')
        elif name == DatasetLoader.CELEBA_HQ:
            return  load_dataset('imagefolder', data_dir="./datasets/celeba_hq_256", split='train')
        else:
    ...
    def get_dataloader(self) -> torch.utils.data.DataLoader:
        ...
        return DataLoader(datasets, batch_size=self.__batch_size, shuffle=self.__shuffle, pin_memory=True, num_workers=2)
